...
// Re-adding imports for data seeding
    ...
    CommandLineRunner initDatabase(UserRepository userRepo,
        ...
        return args -> {
            ...
            if (userRepo.count() == 0) {
                ...
                // --- 2. Create Courses ---
                Course swe = new Course(null, "Software Engineering", "Intro to SWE", 3,
                        teacher1, Set.of(DayOfWeek.MONDAY, DayOfWeek.WEDNESDAY),
                        LocalTime.of(9, 0), LocalTime.of(10, 15));

                Course ds = new Course(null, "Data Structures", "Core CS concepts", 3,
                        teacher2, Set.of(DayOfWeek.TUESDAY, DayOfWeek.THURSDAY),
                        LocalTime.of(10, 30), LocalTime.of(11, 45));

                Course calc = new Course(null, "Calculus I", "Intro to Calculus", 4,
                        teacher1, Set.of(DayOfWeek.MONDAY, DayOfWeek.WEDNESDAY),
                        LocalTime.of(13, 0), LocalTime.of(14, 15));

                Course conflict = new Course(null, "Conflict Course", "A course for testing", 3,
                        teacher2, Set.of(DayOfWeek.MONDAY),
                ...
                StudentCourse enrollment3 = new StudentCourse(null, student2, ds);  // jane.doe@test.com is in Data Structures
